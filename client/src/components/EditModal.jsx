...
class EditModal extends Component {
    ...
    onSubmit(event) {
        ...
        axios
            .post('https://localhost:5000/api/user/updatemovie/' + this.state.movieId, qs.stringify({title: this.refs.title.value, released: this.refs.released.value, url: this.refs.url.value}))
