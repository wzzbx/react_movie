...
class AddModal extends Component {
    ...
    onSubmit(event) {
        ...
        axios
            .post('http://localhost:3000/api/user/' + this.props.email + '/createmovie', qs.stringify({title: this.refs.title.value, released: this.refs.released.value, url: this.refs.url.value}))
